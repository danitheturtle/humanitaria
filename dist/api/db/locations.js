...
exports.searchLocations = exports.getSearchLocationsConnection = exports.getLocations = exports.getLocationNear = exports.getLocation = void 0;
...
const getLocationNear = async (lat, lon, zoom = 18) => {
  var _foundLocation;
  debugger;
  let foundLocation = {};
  try {
    foundLocation = await (0, _axios.default)({
      method: 'get',
  ...
  return (0, _models.osmToLocationType)((_foundLocation = foundLocation) === null || _foundLocation === void 0 ? void 0 : _foundLocation.data);
};
exports.getLocationNear = getLocationNear;
const searchLocations = async (query, limit, excludedPlaceIds = []) => {
  debugger;
  let osmResultsByRelevance = {
    data: []
  };
  try {
    osmResultsByRelevance = await (0, _axios.default)({
      method: 'get',
      baseURL: process.env.NOMINATIM_ORIGIN,
  ...
  return osmResultsByRelevance.data.map(_models.osmToLocationType);
};
exports.searchLocations = searchLocations;
const getSearchLocationsConnection = async (cursor, first, query) => {
...
exports.getSearchLocationsConnection = getSearchLocationsConnection;
const getLocations = async (osmIDs = []) => {
  debugger;
  let osmResults = [];
  try {
    let {
      data: osmResultsResponse
  ...
  return osmResults.map(_models.osmToLocationType);
};
exports.getLocations = getLocations;
const getLocation = async osmID => {
